                ...
                <div className={cx('form_body')}>
                        ...
                        {userList?.map((user) => {
                            if (user.id === currentUser?.id) {
                                ...
                                return (
                                    <li
                                        key={user.id}
                                        className={cx('search_history_item')}
                                    >
                                        <Avatar
                                            className={cx(
                                                'search_history_item_avt',
                                            )}
                                            name={user.fullname}
                                            size="38px"
                                        />
                    ...
                    {/* <ul className={cx('search_history_list')}>
                        <li className={cx('search_history_item')}>
                            <Image
                                className={cx('search_history_item_avt')}
                                src="./image/avt.jpg"
                            />
                            <div className={cx('search_history_item_info')}>
                                <h5 className={cx('search_history_item_name')}>
                                    Nguyễn Thành Hải
                                </h5>
                                <p className={cx('search_history_item_phone')}>
                                    Từ gợi ý kết bạn
                                </p>
                            </div>
                            <button className={cx('search_history_item_btn')}>
                                Kết bạn
                            </button>
                        </li>
                        <li className={cx('search_history_item')}>
